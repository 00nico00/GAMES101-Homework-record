...
Eigen::Matrix4f get_projection_matrix(float eye_fov, float aspect_ratio, float zNear, float zFar)
{
	...
	float top = tan_half_fov * abs(zNear);
	float bottom = -top;
...
int main(int argc, const char** argv)
{
	...
	objl::Loader Loader;
	std::string obj_path = "F:/Games101-Homework/Assignment3/models/spot/";

	// Load .obj File
	bool loadout = Loader.LoadFile("F:/Games101-Homework/Assignment3/models/spot/spot_triangulated_good.obj");
	...
	if (argc >= 2)
	{
		...
		if (argc == 3 && std::string(argv[2]) == "texture")
		{
			...
			//texture_path = "spot_texture_100.png";
			r.set_texture(Texture(obj_path + texture_path));
